...
const wish = { fontSize: "13px", paddingLeft: "20px", fontWeight: "bold" };
                ...
                <div className={styles.dropdownContent}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>Jackets</div>
                      <div
                        style={{ color: "#F433FF", borderTop: "1px solid red" }}
                      >
                        Belts, Scarves & More
                      </div>
                      <div
                ...
                <div className={styles.dropdownContent}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>Socks</div>
                      <div
                        style={{ color: "	#FF4500", borderTop: "1px solid red" }}
                      >
                        Toys
                      </div>
                ...
                <div className={styles.dropdownContent}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>Sofa Covers</div>
                      <div
                        style={{ color: "#FFD700", borderTop: "1px solid red" }}
                      >
                        Flooring
                      </div>
                    ...
                    >
                      ...
                      <div style={{ color: "#FFD700" }}>Home Gift Sets</div>
                    </div>
                    <div
                      style={{
                        display: "grid",
                ...
                <div className={styles.dropdownContent}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>Hand Cream</div>
                      <div
                        style={{ color: "#04aa6d", borderTop: "1px solid red" }}
                      >
                        Baby Care
                      </div>
                      <div>Masks</div>
